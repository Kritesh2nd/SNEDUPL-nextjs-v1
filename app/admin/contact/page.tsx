...
export default function AdminContactPage() {
  ...
  const validate = () => {
    ...
    if (!form.factoryAddress.trim())
      e.factoryAddress = "Factory address required";
    ...
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-white/40 text-sm mt-1">
          Update public contact details shown across the website
        </p>
      </div>
      ...
      >
        ...
        <Textarea
          ...
          onChange={(e) => {
            setField("factoryAddress", e.target.value);
            clearErr("factoryAddress");
          }}
