...
const FILTERS: {
  ...
  {
    value: "OTHER_DISTILLED",
    label: "Other Spirits",
    desc: "Diversified spirits",
  },
      ...
      <section className="relative py-16 md:py-24 page-hero-bg overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h1 className="font-display text-5xl md:text-6xl text-white mt-3 mb-4">
            Spirits Crafted to
            <br />
            <span className="text-electric-green">Perfection</span>
          </h1>
          <p className="text-white/45 text-base max-w-xl mx-auto leading-relaxed">
            30+ expressions spanning soju, whisky, vodka, ready-to-drink, and
            more — every bottle a testament to Himalayan craftsmanship.
          </p>
        </div>
      </section>
              ...
              <div className="sticky top-24 space-y-1">
                ...
                {FILTERS.map((f) => (
                  ...
                  >
                    ...
                    <span
                      className={`text-[10px] px-1.5 py-0.5 rounded-full ${filter === f.value ? "bg-black/20 text-black" : "text-white/30"}`}
                    >
                      {counts[f.value] || 0}
                    </span>
                  </button>
