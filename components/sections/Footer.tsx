    ...
    >
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-8">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-white/40 text-xs leading-relaxed max-w-xs mb-4">
              Nepal&apos;s emerging premium spirits house. Crafted with
              precision, distilled for the world.
            </p>
            ...
            <ul className="space-y-2.5">
              {NAV_LINKS.map((l) => (
                <li key={l.href}>
                  <Link
                    href={l.href}
                    className="text-xs text-white/40 hover:text-[var(--g400)] transition-colors duration-200"
                  >
                    {l.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-2 text-xs text-white/40 hover:text-[var(--g400)] transition-colors"
              >
                <Phone size={11} />
                {contactInfo.phone}
              </a>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <Link
            href="/admin"
            className="text-[10px] text-white/15 hover:text-white/40 transition-colors tracking-wider uppercase"
          >
            Admin Portal
          </Link>
        </div>
